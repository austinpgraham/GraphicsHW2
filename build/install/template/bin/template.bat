...
set DEFAULT_JVM_OPTS="-Xms128m" "-Xmx756m" "-noclassgc" "-Dfile.encoding=utf-8" "-Dapple.laf.useScreenMenuBar=false" "-Dapple.awt.showGrowBox=true" "-Dapple.awt.brushMetalLook=false" "-Dapple.awt.antialiasing=on" "-Dapple.awt.graphics.UseQuartz=true"
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEMPLATE_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.example.Template %CMD_LINE_ARGS%
