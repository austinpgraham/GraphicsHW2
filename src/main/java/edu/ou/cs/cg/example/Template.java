...
/**
 * The <CODE>Template</CODE> class.<P>
 *
 * @author  Chris Weaver
 * @version %I%, %G%
 */
	...
	implements GLEventListener
{
	...
	public static void main(String[] args)
	{
		...
		canvas.addGLEventListener(new Template());
	...
	private void	drawSomething(GL2 gl)
	{
		...
		gl.glPointSize(2.0f);
		gl.glVertex2d((double)(k / 600.0), (double)(k / 1200.0));
	...
	private void	drawSomeText(GLAutoDrawable drawable)
	{
		...
		renderer.draw("This is a point" + k, w/2 + 8, h/2 - 5);
